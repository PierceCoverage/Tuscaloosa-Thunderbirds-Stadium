...
function StaminaController:StaminaRegen()
	if self.Running then
		while self.Running and self.CurStam > 0 do
			...
			self.UI.BG.BG2.Bar.Size = UDim2.new(self.CurStam / self.MaxStam, 0, 1, 0)
			self.UI.BG.BG2.Bar.BackgroundColor3 =
				Color3.new(1 - self.CurStam / self.MaxStam, self.CurStam / self.MaxStam, 0)
		end
		self.Running = false
